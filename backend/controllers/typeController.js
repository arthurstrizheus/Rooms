...
const Post = async (req, res) => {
    try {
        ...
        const { value, color, created_user_id } = req.body;
        ...
        const newResource = await Type.create({
            value,
            color,
            created_user_id,
        });
...
const Update = async (req, res) => {
    try {
        ...
        const { value, color, created_user_id } = req.body;  // Extract data from the request body
        ...
        const resource = await Type.findByPk(id);
        if (!resource) {
