            ...
            >
              <FormControl sx={{ marginTop: "10px", width: "100%" }}>
                ...
                >
                  {groups
                    .filter(
                      (gp) => gp.access != "Read" && gp.id != 12 && gp.id != 13
                    )
                    ?.map((name, index) => (
                      <MenuItem
                        key={index}
              ...
              <FormControl sx={{ marginTop: "10px", width: "100%" }}>
                ...
                >
                  {groups
                    .filter(
                      (gp) => gp.access != "Full" && gp.id != 12 && gp.id != 13
                    )
                    ?.map((name, index) => (
                      <MenuItem
                        key={index}
                ...
                <Input
                  ...
                  endAdornment={
                    <InputAdornment position="end">
                      <Tooltip
                        title={
                          viewPassword ? "Hide password" : "Unhide password"
                        }
                      >
                        <IconButton
