                ...
                title={
                    <>
                        <Grid textAlign={'center'}>
                            ...
                            <Typography fontSize={13} variant="caption" >{getHours(meeting.start_time)}:{String(start.getMinutes()).padStart(2, '0')}{getAmPm(start)}m - {end.getHours() > 12 ? end.getHours() - 12 : end.getHours()}:{String(end.getMinutes()).padStart(2, '0')}{getAmPm(end)}m</Typography>
                        </Grid>
                    </>
                }
                arrow
