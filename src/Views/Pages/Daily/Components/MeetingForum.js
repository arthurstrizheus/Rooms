...
const MeetingFourm = ({
  ...
  useEffect(() => {
    ...
    data();
    if (!update) {
      const startTimeString = times?.find(
        (tm) =>
          tm ===
          `${meeting.hour}:${
            meeting.min < 10 ? `0${meeting.min}` : meeting.min
          }${meeting.hour > 5 && meeting.hour < 12 ? "am" : "pm"}`
      );
      const endTimeString = times?.find(
        (tm) =>
          tm ===
          `${
            meeting.min < 45
              ...
              ? meeting.hour + 1
              : "1"
          }:${meeting.min < 45 ? meeting.min + 15 : "00"}${
            meeting.am && `${meeting.hour}:${meeting.min}` !== "11:45"
              ? "am"
              : "pm"
          }`
      );
            ...
            >
              <Button
                ...
                sx={{
                  ...
                  ":hover": {
                    background:
                      theme.palette.background.fill.alert.warningLight,
                  },
                  fontWeight: "bold",
                }}
                startIcon={<TuneIcon />}
              ...
              <Button
                ...
                sx={{
                  ...
                  ":hover": {
                    background:
                      theme.palette.background.fill.alert.successLight,
                  },
                  fontWeight: "bold",
                }}
                onClick={onSubbmit}
