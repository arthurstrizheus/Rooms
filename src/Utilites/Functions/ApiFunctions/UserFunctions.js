...
export async function PostUser(data) {
  try {
    const resp = await axios.post(process.env.REACT_APP_API + "/users", data);
...
export async function DeleteUser(id) {
  try {
    const resp = await axios.delete(process.env.REACT_APP_API + `/users/${id}`);
...
export async function UpdateUserDetails(id, data) {
  try {
    const resp = await axios.put(
      process.env.REACT_APP_API + `/users/details/${id}`,
      data
    );
...
export async function UpdateUserPassword(id, data) {
  try {
    const resp = await axios.put(
      process.env.REACT_APP_API + `/users/password/${id}`,
      data
    );
...
export async function ActivateUser(data) {
  try {
    const resp = await axios.put(
      process.env.REACT_APP_API + `/users/activate/${data}`
    );
    const errorCheck = handleApiResponseError(resp);
    if (errorCheck.isError && errorCheck?.message) {
      showError(errorCheck.message);
...
export async function DeactivateUser(data) {
  try {
    const resp = await axios.put(
      process.env.REACT_APP_API + `/users/deactivate/${data}`
    );
    const errorCheck = handleApiResponseError(resp);
    if (errorCheck.isError && errorCheck?.message) {
      showError(errorCheck.message);
