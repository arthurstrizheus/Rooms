...
export async function GetLocations() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/locations?_=${new Date().getTime()}`,
      {
        headers: {
...
export async function GetRooms(userId) {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/rooms/${userId}?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetBlockedDatess() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/blockeddates?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetGroups() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/groups?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetGroupUsers() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/groupusers?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
  ...
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API +
        `/groups/user/${id}?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetMeetingGroups() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/meetinggroups?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetMeetings() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/meetings?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetMeetingApprovals(id) {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API +
        `/meetings/needsapproved/${id}?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetMeetingsByUserId(id, data) {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API +
        `/meetings/user/${id}?_=${new Date().getTime()}`,
      { params: { ...data } },
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
...
export async function GetMeetingsUserCreated(id, data) {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API +
        `/meetings/created/${id}?_=${new Date().getTime()}`,
      { params: { ...data } },
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
...
export async function GetResources() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/resources?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetRoomGroups() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/roomgroups?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetRoomResources() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/roomresources?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetTypes() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/types?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export async function GetUsers() {
  try {
    const resp = await axios.get(
      process.env.REACT_APP_API + `/users?_=${new Date().getTime()}`,
      {
        headers: {
          "Cache-Control": "no-cache", // Prevent caching
          Pragma: "no-cache",
...
export function UserAnyAccessRooms(
  ...
  const roomGroups = RoomGroups.filter(
    (rg) => rg.group_id === usersGroups?.find((ug) => ug.id == rg.group_id)?.id
...
export function UsersGroups(GroupUsers, Groups, user) {
  ...
  const groups = Groups.filter(
    (gp) => gp.id === usersGroups?.find((ug) => ug.group_id === gp.id)?.group_id
